...
function read_solomon(filename::String)
    open(filename, "r") do io
        ...
        tokens = split(strip(text))     # vetor de strings limpas        
...
function printVRPTW(solver::Solver, sol::Solution)
    ...
    for r = 1:length(sol.routes)
        ...
        cont += 1
        time = sol.forwardLabels[r][end].custom_res.RD
        demand = 0.
        print("#$cont: ")
...
function main(instance::String, restarts::Int, outerIterMax::Int, innerIterMax::Int, seed::Int)
    instName = split(instance, ".")[1][9:end]
    ...
    # plot_vrptw(x, y, demands, solver.outerBestSol, filename = instName)
...
innerIterMax = 5
seed         = 2
instance = "TWRD/100/C104_100_015.vrptwrd"
...
# instances = readdir("/mnt/c/Users/bruno.mattos/OneDrive - americanas s.a/Documentos/GitHub/GenericILS/TWRD/25")
# open("/mnt/c/Users/bruno.mattos/OneDrive - americanas s.a/Documentos/GitHub/GenericILS/res.out", "w") do f
#     write(f, "instance,cost \n")
# end
# for inst in instances
#     instance = "TWRD/25/$inst"
#     costt = main(instance, restarts, outerIterMax, innerIterMax, seed)
#     open("/mnt/c/Users/bruno.mattos/OneDrive - americanas s.a/Documentos/GitHub/GenericILS/res.out", "a") do f
#         write(f, "$inst,$costt\n")
#     end
# end
